...
function calc() {
  ...
  function calcTotal() {
    if (!sex || !height || !weight || !age || !ratio) {
      ...
      return; //нужен, чтобы прервать функцию - дальше она не пойдет, если условие выполняется
    }
...
function cards() {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.gerResource)('http://localhost:3000/menu').then(data => {
    data.forEach(_ref => {
      let {
        img,
        altimg,
...
function slider(_ref) {
  ...
  const slider = document.querySelector(container),
        ...
        width = window.getComputedStyle(slidesWrapper).width; // 1 способ (простое переключение картинок)
  // let index = 1;
  // if (slides.length < 10) {
...
function tabs(tabsSelector, tabContentSelector, tabParentSelector, activeClass) {
  ...
  let tabs = document.querySelectorAll(tabsSelector),
      ...
      tabParent = document.querySelector(tabParentSelector); // function hideTabContent() {
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2022-09-01');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_7__["default"])('form', modalTimeId);
